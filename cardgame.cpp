...
{
  case GUESS_SUIT:
      logs << "Number of Posibilities: " << cards.deckSize() << std::endl;
      logs << "You are Guessing the Suit: \nYour Choice: " 
         << suit << std::endl;
      ...
      logs << "Actual Card: " << cards.getCard() << std::endl << std::endl;
    break;
  
  case GUESS_RANK:
      logs << "Number of Posibilities: " << cards.deckSize() << std::endl;
      logs << "You are Guessing the Rank: \nYour Choice: " 
         << rank << std::endl;
  ...
  case GUESS_BOTH:
      logs << "Number of Posibilities: " << cards.deckSize() << std::endl;
      logs << "You are Guessing Both Rank and Suit: \nYour Choice: " 
